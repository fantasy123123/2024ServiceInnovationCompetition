        ...
        <div style={{
            ...
            <div style={{width:'90%',height:'100%'}}>
                ...
                <div style={{width:'100%',height:'27%',marginTop:'5%',textAlign:'center'}}>
                    ...
                    <br />
                    <br />
                    <span style={{fontSize:15}}>前端：<a>https://github.com/fantasy123123/2024ServiceInnovationCompetition</a><br />后端：https://github.com/elpkijj/RecommendationSystem</span>
                </div>
            </div>
        </div>
        <div style={{
