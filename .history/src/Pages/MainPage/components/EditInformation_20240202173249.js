            ...
            <Form layout="vertical" style={{width:'100%',height:'85%',marginTop:15,position:'relative'}}>
                <div style={{width:'30%',position:'absolute',left:0,bottom:0}}>
                                ...
                                {['男', '女',].map((item) => {
                                    return (
                                        <Radio key={item} value={item}>
                                            {({ checked }) => {
                                                return (
                                                    <Button tabIndex={-1} key={item} style={checked?{width:70,background:'rgba(60,192,201,100%)',color:'white'}:{width:70,background:'white',border:'solid 1px grey'}}>
                                                        {item}
                                                    </Button>
                                                );
                                            }}
                    ...
                    <FormItem style={{position:'absolute',bottom:'-18%',textAlign:'right'}}>
                        <Button style={{width:80}}>取 消</Button>
                        <Button style={{width:80,color:'white',marginLeft:30,marginRight:50,background:'rgba(60,192,201,100%)'}}>完 成</Button>
                    </FormItem>
                </Form>
        </div>
    </div>
