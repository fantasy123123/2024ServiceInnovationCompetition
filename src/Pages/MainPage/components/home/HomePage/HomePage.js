...
import link from "../ApplyForJob/image/link.png";
const HomePage=()=>{
                ...
                <div style={{width:'100%',height:'27%',marginTop:'5%'}}>
                    ...
                    <span style={{fontSize:15}}>
                        <div style={{display:'flex',alignItems:'center',justifyContent:'center'}}>
                             <img  src={link} alt='' style={{width:15,height:17,marginRight:5}}/>
                             前端：
                             <a onClick={()=>{window.open('https://github.com/fantasy123123/2024ServiceInnovationCompetition')}} style={{textDecoration:'none',color:'blue',cursor:'pointer'}}>https://github.com/fantasy123123/2024ServiceInnovationCompetition</a>
                        </div>
                         <div style={{display:'flex',alignItems:'center',justifyContent:'center',marginTop:5}}>
                             <img  src={link} alt='' style={{width:15,height:17,marginRight:5}}/>
                             后端：
                             <a  onClick={()=>{window.open('https://github.com/elpkijj/RecommendationSystem')}} style={{textDecoration:'none',color:'blue',cursor:'pointer'}}>https://github.com/elpkijj/RecommendationSystem</a>
                         </div>
                    </span>
                </div>
            </div>
